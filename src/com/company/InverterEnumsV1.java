...
class InverterEnumsV1 extends InverterEnumsBase {
    ...
    private HashMap<inverterEEPROMStart, Integer> inverterEEPROMStartValues = new HashMap<>() {
        {
            ...
            put(inverterEEPROMStart.inverter_freq_min_in, 168);
            ...
            put(inverterEEPROMStart.inverter_current_nom_out_V1, 180);
            put(inverterEEPROMStart.inverter_current_max_out_V1, 184);
            put(inverterEEPROMStart.inverter_current_nom_in_V2_1, 188);
            put(inverterEEPROMStart.inverter_current_nom_in_V2_2, 192);
            put(inverterEEPROMStart.inverter_current_nom_out_V2, 196);
            put(inverterEEPROMStart.inverter_current_max_out_V2, 200);
    ...
    private HashMap<inverterEEPROMLength, Integer> inverterEEPROMLengthValues = new HashMap<>() {
        {
            ...
            put(inverterEEPROMLength.inverter_current_nom_out_V1, 4);
            ...
            put(inverterEEPROMLength.inverter_current_nom_out_V2, 4);
